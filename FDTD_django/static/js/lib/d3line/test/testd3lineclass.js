  ...
  describe("TEST D3line class", function() {
    ...
    describe('_set_scale', function() {
      ...
      it('set xScale', function() {
        ...
        return assert.equal(this.d3line.xScale(2010), this.d3line.width - this.d3line.margins.right);
      });
      return it('set yScale', function() {
        assert.equal(this.d3line.yScale(134), this.d3line.height - this.d3line.margins.bottom);
        return assert.equal(this.d3line.yScale(215), this.d3line.margins.top);
      });
    });
